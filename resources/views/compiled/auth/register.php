<?php class_exists('Chomsky\View\StencilEngine') or exit; ?>
<!DOCTYPE html>
<html lang="en">
  <link
    rel="stylesheet"
...
<form method="post">
  <div class="mb-3">
    ...
    <input value="<?php echo old('email') ?>" name="email" type="email" class="form-control">
  ...
  <div class="mb-3">
    ...
    <div class="text-danger"><?php echo error('confirm_password') ?></div>
